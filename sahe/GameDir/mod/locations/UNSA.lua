local this={
	...
	locationId=120, --LocationId, also found in the TppLocationData in pack_common.fpkd's common_data DataSet, though there it can be set to 0, like here and in MGO maps, and it works fine. Here the id is near-after 113, the last MGO map.
	packs={
