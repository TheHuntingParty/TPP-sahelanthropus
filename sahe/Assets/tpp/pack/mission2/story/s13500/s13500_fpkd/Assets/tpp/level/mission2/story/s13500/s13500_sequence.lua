...
function this.OnRestoreSVars()
	...
	if TppSequence.GetMissionStartSequenceName() == "Seq_Demo_SahelanAppearance" then
		svars.isCleards13500 = TppStory.IsMissionCleard(10151)	
...
this.OnEndMissionReward = function()
	...
	elseif svars.isCleards13500 then	
...
this.OnEndMissionPrepareSequence = function ()
	...
	if TppSequence.GetMissionStartSequenceName() == "Seq_Demo_SahelanAppearance" or
		...
		Fox.Log("____________s13500_sequence.ResetGimmick()")
...
this.s13500_baseOnActiveTable = {
	afgh_powerPlant = function()
		Fox.Log("s13500_baseOnActiveTable : afgh_powerPlant")
...
sequences.Seq_Game_BattleSahelan = {
	...
	SetHeliSequenceCamera = function()
		Fox.Log("______s13500_sequence.SetHeliSequenceCamera()")
...
sequences.Seq_Demo_BreakSahelan = {
	...
	OnEnter = function()
		...
		s13500_demo.BreakSahelan( funcs )
...
sequences.Seq_Demo_DeadSkullFace = {
	...
	OnEnter = function()
		...
		s13500_demo.DeadSkullFace( funcs )
...
sequences.Seq_Game_KillSkullFace = {
		...
		StrCode32Table {
			...
			Timer = {
				...
				{ 	msg = "Finish",sender = "ShotDemoTimer",
					func = function()
						Fox.Log("_______s13500_sequence.messages/ ShotDemoTimer ____  mvars.shotCount:" .. tostring(mvars.shotCount))
						
						s13500_demo.ShotSkullChangeCamera(funcs)
					end,
					option = {
						isExecDemoPlaying = true,
						isExecMissionClear = true,
	...
	OnEnter = function(self)
		...
		TppGameStatus.Set( "s13500","S_ENABLE_TUTORIAL_PAUSE" )
	...
	FireSkull = function(shotSeq)
		Fox.Log("_______s13500_sequence.Seq_Game_KillSkullFace.FireSkull____  shotcount:" .. tostring(shotSeq))
	...
	PlaySkullMotion = function(motionPath)
		Fox.Log("_______s13500_sequence.Seq_Game_KillSkullFace.PlaySkullMotion____  motionPath :" .. tostring(motionPath))
	...
	SetUpSkullFace = function()
		Fox.Log("_______s13500_sequence.Seq_Game_KillSkullFace.SetUpSkullFace()")
...
sequences.Seq_Demo_AfterDeadSkullFace = {
	...
	OnEnter = function()
		...
		s13500_demo.AfterDeadSkullFace( funcs )
	end,
}
...
sequences.Seq_Loading_SetUpAvatar = {
	OnEnter = function()
		Fox.Log("________s13500_sequence.Seq_Loading_SetUpAvatar.OnEnter()____________")
		TppSequence.SetNextSequence( "Seq_Demo_Ending2", { isExecMissionClear = true } )
	end,
}
	...
	Messages = function( self ) 
		...
		StrCode32Table {
			UI = {
				{ 	msg = "TppEndingMainStaffFinish",
					func = function()
						Fox.Log( "_________s13500_sequence.Messages(): Demo: TppEndingMainStaffFinish" )
...
sequences.Seq_Loading_ResetAvatar = {
	...
	OnEnter = function()
		Fox.Log("________s13500_sequence.Seq_Loading_ResetAvatar.OnEnter()____________")
		
		if svars.isCleards13500 then
			TppSequence.SetNextSequence( "Seq_Demo_Ending3", { isExecMissionClear = true } )
		else
			TppSequence.SetNextSequence( "Seq_movie_Preview", { isExecMissionClear = true } )
		end
		...
		StrCode32Table {
			Block = {
			{
				...
				func = function (blockName,blockState)
					Fox.Log("________s13500_sequence.OnScriptBlockStateTransition________")
